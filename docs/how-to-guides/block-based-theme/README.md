...
## Table of Contents
 ...
 4. [theme.json - Global styles](/docs/how-to-guides/block-based-themes/README.md#theme-json-global-styles)
...
The theme may optionally include a [theme.json file](/docs/how-to-guides/themes/theme-json.md) to manage global styles. You decide what additional templates and template parts to include in your theme.
